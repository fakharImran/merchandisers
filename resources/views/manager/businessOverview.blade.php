...
<div class="container business-overview">
        ...
        <div class="col-md-3-5 col-sm-3 col-6 pt-2">
            <div class="card manager-card-style">
                ...
                <div class="card-body content">
                    ...
                    @php
                        $uniqueStoreCount=$stores->unique('name_of_store');
                        $expiredProduct=array();
                        foreach ($productExpiryTrackerData as $key => $productExpiry) {
                            if($productExpiry->expiry_date<$todayDate->format('Y-m-d'))
                            {
                                array_push($expiredProduct,$productExpiry);
                            }
                        }
    ...
    <div class="col-12" style="display: none">
        ...
        <div class="table-responsive" >
                {{-- table-responsive --}}
                {{-- nowrap --}}
            <table id="businessOverviewDatatable" class="table table-sm  datatable table-hover  " style="border: 1px solid #ccc; min-width: 1580px; ">
                <thead>
                    <tr>
...
<script>
    ...
    const parishes = [
        { name: 'Clarendon', lat: 17.9649, lng: -77.2452 },
        { name: 'Hanover', lat: 18.4054, lng: -78.0572 },
        { name: 'Kingston', lat: 17.9702, lng: -76.7936 },
        { name: 'Manchester', lat: 18.0362, lng: -77.5071 },
        { name: 'Portland', lat: 18.1597, lng: -76.5346 },
        { name: 'St. Andrew', lat: 18.0340, lng: -76.7495 },
        { name: 'St. Ann', lat: 18.1096, lng: -77.2975 },
        { name: 'St. Catherine', lat: 17.9641, lng: -76.8674 },
        { name: 'St. Elizabeth', lat: 18.1352, lng: -77.2177 },
        { name: 'St. James', lat: 18.4153, lng: -77.0810 },
        { name: 'St. Mary', lat: 18.1026, lng: -76.9873 },
        { name: 'St. Thomas', lat: 17.9394, lng: -76.7952 },
